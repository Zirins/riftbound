...
// Hero roster — Phase 5 expands this stub.
...
export class RosterScene extends Phaser.Scene {
  ...
  create(): void {
    ...
    this.add.text(CANVAS.WIDTH / 2, 80, 'MY RELIC BEARERS', {
      fontSize: '22px',
      color: '#ffffff',
      fontFamily: 'monospace',
    }).setOrigin(0.5);

    this.add.text(CANVAS.WIDTH / 2, CANVAS.HEIGHT / 2, 'RosterScene stub — Phase 5', {
      fontSize: '14px',
      color: '#aaaacc',
      fontFamily: 'monospace',
    }).setOrigin(0.5);
