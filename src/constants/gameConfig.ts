...
export const HERO_NEW = {
  ...
  LIN: {
    ID: 'lin_hollowshade',
    COLOR: 0x2A1038, RADIUS: 18,
    BASE_HP: 920, HP_PER_LEVEL: 60, BASE_ATTACK: 155, ATTACK_PER_LEVEL: 13,
    BASE_DEFENSE: 18, DEFENSE_PER_LEVEL: 1, ATTACK_COOLDOWN: 900, SPEED: 168,
    ENERGY_GAIN_ON_HIT: 15, ENERGY_GAIN_ON_TAKEN: 8,
    ISOLATION_RADIUS: 100, ISOLATION_DAMAGE_BONUS: 0.30,
    ULTIMATE_DAMAGE: 420,
  },
  WEI: {
    ID: 'wei_argentblade',
    COLOR: 0x8A9BB5, RADIUS: 20,
    BASE_HP: 1000, HP_PER_LEVEL: 68, BASE_ATTACK: 150, ATTACK_PER_LEVEL: 12,
    BASE_DEFENSE: 32, DEFENSE_PER_LEVEL: 2, ATTACK_COOLDOWN: 850, SPEED: 140,
    ENERGY_GAIN_ON_HIT: 14, ENERGY_GAIN_ON_TAKEN: 14,
    DISCIPLINE_STACK: 0.04, DISCIPLINE_MAX_STACKS: 8, DISCIPLINE_DURATION: 8000,
    ULTIMATE_DAMAGE: 380,
  },
  FEN: {
    ID: 'fen_phantomcall',
    COLOR: 0x3D7A8C, RADIUS: 19,
    BASE_HP: 850, HP_PER_LEVEL: 55, BASE_ATTACK: 100, ATTACK_PER_LEVEL: 7,
    BASE_DEFENSE: 22, DEFENSE_PER_LEVEL: 2, HEAL_COOLDOWN: 2400, SPEED: 120,
    ENERGY_GAIN_ON_ABILITY: 12, ENERGY_GAIN_ON_TAKEN: 10,
    PHANTOM_HASTE: 1.0, PHANTOM_DURATION: 4500,
    ULTIMATE_HEAL: 180,
  },
  LIAN: {
    ID: 'lian_sunscourge',
    COLOR: 0xE8C547, RADIUS: 19,
    BASE_HP: 900, HP_PER_LEVEL: 58, BASE_ATTACK: 145, ATTACK_PER_LEVEL: 12,
    BASE_DEFENSE: 16, DEFENSE_PER_LEVEL: 1, ATTACK_COOLDOWN: 1200, SPEED: 110,
    ENERGY_GAIN_ON_HIT: 12, ENERGY_GAIN_ON_TAKEN: 10,
