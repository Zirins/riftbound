...
const ACHIEVEMENT_LIST: AchievementDefinition[] = [
  ...
  // ─── Economy (10) ──────────────────────────────────────────────────────────
  {
    ...
    category: 'economy',
    name: 'Covenant Patron',
    description: 'Contribute to your Covenant 5 times.',
    hiddenDescription: '???',
    isHidden: false,
  ...
  },
  {
    ...
    description: 'Contribute to your Covenant 25 times.',
    hiddenDescription: '???',
    isHidden: false,
  ...
  // ─── Social (5) ────────────────────────────────────────────────────────────
  {
    ...
    category: 'social',
    name: 'Bound by Covenant',
    description: 'Join a Covenant.',
    hiddenDescription: '???',
    isHidden: false,
  ...
  },
  {
    ...
    category: 'social',
    name: 'Pillar of the Covenant',
    description: 'Contribute to your Covenant 50 times.',
    hiddenDescription: '???',
    isHidden: false,
  ...
  },
  {
    ...
    category: 'hidden',
    name: 'Covenant Founder',
    description: 'Join a Covenant.',
    hiddenDescription: 'Take your place in a Covenant.',
    isHidden: true,
    trigger: { kind: 'event_count', event: 'covenant_joined', target: 1 },
    reward: achievementReward(12),
  },
