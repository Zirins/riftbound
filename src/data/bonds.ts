...
export const PAIR_BOND_DEFINITIONS: PairBondDefinition[] = [
  {
    id: 'pair_kael_thane',
    name: 'Iron Bastion',
    description: 'Kael and Thane Ironroot stand together.',
  ...
  },
  {
    id: 'pair_mira_caira',
    name: 'Radiant Veil',
    description: 'Mira and Caira Dawnveil share the morning light.',
  ...
  },
  {
    ...
    description: 'Sura and Marek Stormreign charge as one.',
  ...
  },
  {
    id: 'pair_nyra_ren',
    name: 'Veil Hunters',
    description: 'Nyra and Ren Vale strike from the shadows.',
  ...
  },
  {
    ...
    name: 'Mirror Arc',
    description: 'Solenne and Veyra refract the battlefield.',
