...
const suraKit: HeroCombatKit = {
  ...
  passive: skill(
    ...
    'Ember Cleave',
    'passive',
    `Every ${S.CLEAVE_HIT_COUNT} basic attacks, unleash a flame cleave around Sura.`,
    'on_hit',
    'area_circle',
    [
  ...
  sideSkills: [
    ...
    skill(
      ...
      'Reckoning',
      'side',
      'Sura feeds on battle fury, raising attack and stealing life.',
      'cooldown',
      'self',
...
const thaneKit: HeroCombatKit = {
  ...
  passive: skill(
    ...
    'Rootguard',
    'passive',
    'Each hit taken stacks defense — roots anchor Thane against assault.',
    'on_hit',
    'self',
  ...
  sideSkills: [
    ...
    skill(
      ...
      'Bark Wall',
      'side',
      'Raise a bark barrier, shielding Thane and reducing damage taken.',
      'cooldown',
      'self',
